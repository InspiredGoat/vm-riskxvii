...
byte set_mem(void* memory, byte mem_bank_bits, u32 address, void* data, u32 length, VirtualInstructionName* ret_virt_instruction);
...
u32 get_mem(void* memory, byte mem_bank_bits, u32 address, void* ret_data, u32 length);
